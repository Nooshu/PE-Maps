...
const developmentSite = planningMap.polygons.find((polygon) => polygon.id === "development-site")
const wildlifeAndTrees = planningMap.polygons.find((polygon) => polygon.id === "wildlife-and-trees")
const constructionAccess = planningMap.lines.find((line) => line.id === "construction-access")

const map = new InteractiveMap(planningMap.containerId, {
  mapProvider: maplibreProvider(),
  ...interactiveMapOptions(planningMap),
  plugins: [
      ...
      datasets: [
        {
          ...
          geojson: polygonFeatureCollection(planningMap, ["development-site"]),
          minZoom: 1,
          showInMenu: false,
          showInKey: true,
          style: {
        ...
        },
        {
          ...
          geojson: polygonFeatureCollection(planningMap, ["wildlife-and-trees"]),
          minZoom: 1,
          showInMenu: false,
          showInKey: true,
          style: {
        ...
        },
        {
          ...
          geojson: lineFeatureCollection(planningMap, ["construction-access"]),
          minZoom: 1,
          showInMenu: false,
          showInKey: true,
          style: {
...
const bounds = planningMap.bounds
