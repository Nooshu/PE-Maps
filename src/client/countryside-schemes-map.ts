...
const eligibleParcel = countrysideSchemesMap.polygons.find((polygon) => polygon.id === "fosse-field")
const notAvailableParcel = countrysideSchemesMap.polygons.find(
  (polygon) => polygon.id === "lansdowne-ground"
)
const watercourseBuffer = countrysideSchemesMap.polygons.find(
  (polygon) => polygon.id === "windrush-buffer"
)
const designatedSite = countrysideSchemesMap.polygons.find(
  (polygon) => polygon.id === "salmonsbury-sssi"
)
const riverWindrush = countrysideSchemesMap.lines.find((line) => line.id === "river-windrush")

const map = new InteractiveMap(countrysideSchemesMap.containerId, {
  mapProvider: maplibreProvider(),
  ...interactiveMapOptions(countrysideSchemesMap),
  plugins: [
      ...
      datasets: [
        {
          ...
          geojson: polygonFeatureCollection(countrysideSchemesMap, designatedSiteIds),
          minZoom: 1,
          showInMenu: false,
          showInKey: true,
          style: {
        ...
        },
        {
          ...
          geojson: polygonFeatureCollection(countrysideSchemesMap, eligibleParcelIds),
          minZoom: 1,
          showInMenu: false,
          showInKey: true,
          style: {
        ...
        },
        {
          ...
          geojson: polygonFeatureCollection(countrysideSchemesMap, notAvailableParcelIds),
          minZoom: 1,
          showInMenu: false,
          showInKey: true,
          style: {
        ...
        },
        {
          ...
          geojson: polygonFeatureCollection(countrysideSchemesMap, watercourseBufferIds),
          minZoom: 1,
          showInMenu: false,
          showInKey: true,
          style: {
        ...
        },
        {
          ...
          geojson: lineFeatureCollection(countrysideSchemesMap, ["river-windrush"]),
          minZoom: 1,
          showInMenu: false,
          showInKey: true,
          style: {
...
const bounds = countrysideSchemesMap.bounds
